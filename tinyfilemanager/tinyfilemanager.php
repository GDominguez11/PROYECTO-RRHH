...
// Encuentra la posición de "tinyfilemanager.php/"
$posicion_inicio = strpos($url_completa, "tinyfilemanager.php/") + strlen("tinyfilemanager.php/");
$posicion_fin = strpos($url_completa, "?p=");
$texto_deseado = substr($url_completa, $posicion_inicio, $posicion_fin - $posicion_inicio);
...
$default_timezone = "America/Tegucigalpa"; // UTC

// Root path for file manager
// use absolute path of directory i.e: '/var/www/folder' or $_SERVER['DOCUMENT_ROOT'].'/folder'
$root_path = $_SERVER['DOCUMENT_ROOT'].'/PROYECTO-RRHH/files/'.$texto_deseado;
